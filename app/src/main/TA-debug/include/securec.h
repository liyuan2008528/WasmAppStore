...
*             prototype of the library, such as memcpy_s, strcpy_s,
*             strcat_s, strncat_s, and so on.
* History:   
*     1. Date: 
*        Author:  
*        Modification: 
...
/**
 * @defgroup TEE_SEC_FUNCTION  °²È«º¯Êý
 * @ingroup TEE_API
 */
...
/* warning remove stdint.h after we fix size_t mismatch problem */
#include <stdint.h>
...
/*define size_t should be covered by __NEED_size_t
#ifndef size_t
