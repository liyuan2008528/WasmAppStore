...
enum TEE_ObjectAttribute {
	...
	TEE_ATTR_RSA_PSS_SALT_LENGTH = 0xF0000A30,            /**< attribute为RSA_PSS_SALT_LENGTH */
	TEE_ATTR_ECC_PUBLIC_VALUE_X = 0xD0000141,             /**< attribute为ECC_PUBLIC_VALUE_X */
	TEE_ATTR_ECC_PUBLIC_VALUE_Y = 0xD0000241,             /**< attribute为ECC_PUBLIC_VALUE_Y */
	TEE_ATTR_ECC_PRIVATE_VALUE = 0xC0000341,              /**< attribute为ECC_PRIVATE_VALUE */
	TEE_ATTR_ECC_CURVE = 0xF0000441,                      /**< attribute为ECC_CURVE */
};
...
enum TEE_ObjectType {
	...
	TEE_TYPE_DATA_GP1_1 = 0xA00000BF,                   /**< object没有key，为纯数据类型 */
	TEE_TYPE_ECDSA_PUBLIC_KEY = 0xA0000041,       /**< object中的key为ECDSA PUBLIC_KEY */
	TEE_TYPE_ECDSA_KEYPAIR = 0xA1000041,          /**< object中的key为ECDSA KEYPAIR */
	TEE_TYPE_ECDH_PUBLIC_KEY = 0xA0000042,        /**< object中的key为ECDH PUBLIC_KEY */
	TEE_TYPE_ECDH_KEYPAIR = 0xA1000042,           /**< object中的key为ECDH KEYPAIR */

	TEE_TYPE_SM2_DSA_PUBLIC_KEY = 0xA0000045,     /**< object中的key为SM2 PUBLIC_KEY for VERIFY */
	TEE_TYPE_SM2_DSA_KEYPAIR    = 0xA1000045,     /**< object中的key为SM2 KEYPAIR    for VERIFY */
	TEE_TYPE_SM2_KEP_PUBLIC_KEY = 0xA0000046,     /**< object中的key为SM2 PUBLIC_KEY for DERIVE */
	TEE_TYPE_SM2_KEP_KEYPAIR    = 0xA1000046,     /**< object中的key为SM2 KEYPAIR    for DERIVE */
	TEE_TYPE_SM2_PKE_PUBLIC_KEY = 0xA0000047,     /**< object中的key为SM2 PUBLIC_KEY for ENCRYPT or DECRYPT */
	TEE_TYPE_SM2_PKE_KEYPAIR    = 0xA1000047,     /**< object中的key为SM2 KEYPAIR    for ENCRYPT or DECRYPT */
	TEE_TYPE_HMAC_SM3  = 0xA0000007,              /**< object中的key为HMAC_SM3 */
	TEE_TYPE_SM4       = 0xA0000014,              /**< object中的key为SM4 */

	TEE_TYPE_CORRUPTED_OBJECT = 0xA00000BE,       /**< object中的key为CORRUPTED */
};
...
*
* @par 描述:
* 建议使用该函数，不使用TEE_GetObjectInfo。
*
* @attention 无
*
* @param object     [IN]  对象句柄
* @param objectInfo [OUT] 对象信息
*
* @retval #TEE_SUCCESS                     执行成功
* @retval #TEE_ERROR_BAD_PARAMETERS        参数错误
* @retval #TEE_ERROR_STORAGE_NOT_AVAILABLE 安全存储不可用
*
* @par 依赖:
* @li tee_internal_api.h：该接口声明所在的头文件
* @see 无
* @since
*/
...
*
* @par 描述:
* 建议使用该函数，不使用TEE_CopyObjectAttributes。拷贝源对象至目的对象
*
* @attention 无
*
* @param destObject [OUT] 目的对象
* @param srcObject  [IN]  源对象
*
* @retval #TEE_SUCCESS              执行成功
* @retval #TEE_ERROR_BAD_PARAMETERS 参数错误
*
...
*
* @par 描述:
* 建议使用该函数，不使用TEE_RestrictObjectInfo。限制集合描述在objectUsage中，
* 若对应位置1，则对应标记不变；置0，则对应标记清0
*
* @attention 无
*
* @param object      [IN] 对象句柄
* @param objectUsage [IN] 限制集合
*
* @retval #TEE_SUCCESS              执行成功
* @retval #TEE_ERROR_BAD_PARAMETERS 参数错误
*
...
*
* @par 描述:
* 建议使用该函数，不使用TEE_CloseAndDeletePersistentObject
*
* @attention 无
*
* @param object [IN] 对象句柄
...
* @retval #TEE_SUCCESS              执行成功
* @retval #TEE_ERROR_BAD_PARAMETERS 参数错误
* @retval #TEE_ERROR_ACCESS_DENIED  拒绝访问
*
* @par 依赖:
* @li tee_internal_api.h：该接口声明所在的头文件
* @see 无
...
* @attention 无
*
* @param operation             [IN]  操作句柄
* @param operationInfoMultiple [OUT] 接收信息buffer
* @param operationSize         [OUT] 输出buffer长度
*
* @retval #TEE_SUCCESS              执行成功
* @retval #TEE_ERROR_BAD_PARAMETERS 参数错误
* @retval #TEE_ERROR_SHORT_BUFFER   缓冲区过小
*
* @par 依赖:
* @li tee_internal_api.h：该接口声明所在的头文件
* @see 无
